...
Messaging other clients is not yet implemented.
...
on the command line, while in the root directory of the Maven project. Then, the client can be run with
'mvn javafx:run' on a separate terminal.